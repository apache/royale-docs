...
Apache Royale began as _"FlexJS"_, a branch of the [Apache Flex project](https://flex.apache.org). The goal was to make a way for the many existing Flex applications users have developed to be deployable outside of the Adobe Flash and Adobe AIR enviromments.
