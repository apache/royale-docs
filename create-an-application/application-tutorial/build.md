...
Since we are interested in JS output, if you're using an [IDE](Get_Started/Development-tools.html), set that output target in the project before compiling. If you're using command-line scripts, run:
