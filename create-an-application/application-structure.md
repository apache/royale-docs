...
Most Royale applications use an [MXML](features/mxml.html) file as the main application file. Other files are written in MXML or [ActionScript](features/as3.html) depending on whether you are assembling pieces or writing custom logic. You can write a Royale Application without using MXML at all, but you'll end up writing more code.
